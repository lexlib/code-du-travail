...
Cet enregistrement est refusé dans le délai d'un mois
...
pour leur application. Sous réserve des dispositions de l'article L. 117-16, le refus d'enregistrement fait obstacle à ce que
le contrat reçoive ou continue de recevoir exécution. La non-réponse dans le même délai a valeur d'acceptation.
